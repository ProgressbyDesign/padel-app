        ...
        return (
          ...
          >
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <Link
                href={`/account/coaches/${encodeURIComponent(coachId)}/availability/${encodeURIComponent(venue.relationshipId)}`}
            ...
            <dl className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              <Summary
                ...
                value={
                  venue.settings
                    ? `${venue.settings.timezone} (${timeZoneAbbreviation(venue.settings.timezone)})`
                    : "Not set"
                }
              />
              <Summary
              ...
              <Summary
                ...
                value={
                  venue.settings
                    ? `${venue.settings.default_slot_duration_minutes} min`
                    : "Not set"
                }
              />
              <Summary
